            ...
            <TrackVisibility>
              {({ isVisible }) => (
                ...
                >
                  ...
                  <p>
                    Projects related to Web Development and Software Engineering
                  </p>
                  <Tab.Container id="projects-tabs" defaultActiveKey="first">
                    ...
                    >
                      ...
                      <Tab.Pane eventKey="first">
                        <p>
                          {" "}
                          Food Ordering Website Based on JavaScript,HTML5 and
                          CSS.
                        </p>
                      </Tab.Pane>
                      <Tab.Pane eventKey="second">
                        <p>
                          MULTITHREADED DOWNLOAD MANAGER Based on Core Java
                          Concepts Such as Multi-Theading and OOPS.
                        </p>
                      </Tab.Pane>
                      <Tab.Pane eventKey="third">
                        <p>
                          Personal Health Monitoring Website Based On
                          JavaScript,HTML5,CSS,SQL and Software Engineering
                          concepts{" "}
                        </p>
                      </Tab.Pane>
                    </Tab.Content>
